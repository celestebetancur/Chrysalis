...
#ifndef YY_YY_WIN_PARSER_CHUCK_TAB_H_INCLUDED
# define YY_YY_WIN_PARSER_CHUCK_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    UNCHUCK = 350,                 /* UNCHUCK  */
    UPCHUCK = 351,                 /* UPCHUCK  */
    DOWNCHUCK = 352,               /* DOWNCHUCK  */
    CLASS = 353,                   /* CLASS  */
    INTERFACE = 354,               /* INTERFACE  */
    EXTENDS = 355,                 /* EXTENDS  */
    IMPLEMENTS = 356,              /* IMPLEMENTS  */
    PUBLIC = 357,                  /* PUBLIC  */
    PROTECTED = 358,               /* PROTECTED  */
    PRIVATE = 359,                 /* PRIVATE  */
    STATIC = 360,                  /* STATIC  */
    ABSTRACT = 361,                /* ABSTRACT  */
    CONST = 362,                   /* CONST  */
    SPORK = 363,                   /* SPORK  */
    ARROW_RIGHT = 364,             /* ARROW_RIGHT  */
    ARROW_LEFT = 365,              /* ARROW_LEFT  */
    L_HACK = 366,                  /* L_HACK  */
    R_HACK = 367,                  /* R_HACK  */
    GRUCK_RIGHT = 368,             /* GRUCK_RIGHT  */
    GRUCK_LEFT = 369,              /* GRUCK_LEFT  */
    UNGRUCK_RIGHT = 370,           /* UNGRUCK_RIGHT  */
    UNGRUCK_LEFT = 371,            /* UNGRUCK_LEFT  */
    AT_OP = 372,                   /* AT_OP  */
    AT_CTOR = 373,                 /* AT_CTOR  */
    AT_DTOR = 374,                 /* AT_DTOR  */
    AT_IMPORT = 375,               /* AT_IMPORT  */
    AT_DOC = 376                   /* AT_DOC  */
  };
...
#line 213 "win-parser/chuck.tab.h"
...
#endif /* !YY_YY_WIN_PARSER_CHUCK_TAB_H_INCLUDED  */
